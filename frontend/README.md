...
* [GTSM1 Variações (Vite)](https://github.com/coreui/coreui-free-react-admin-template)
* [GTSM1 Variações (Create React App)](https://github.com/coreui/coreui-free-react-admin-template-cra)
...
See [the Releases section of our project](https://github.com/coreui/coreui-free-react-admin-template/releases) for changeVariations for each release version.
